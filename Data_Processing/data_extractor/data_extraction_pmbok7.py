...
def main():
    ...
    df_PMBOK7 = pd.read_csv('Risk_Managment_Project/data/PMBOK7_text.csv')  # Adjust path as necessary    
    ...
    output_file = "Projet AI_ LLM/output/respons_data_extraction_sents/PMBOK7_data_extracted.json"
